<header>
    ...
    <div id="action-bar">
        ...
        <div id="lang-content">
            <button>U.S.</button><button class="gray">INTERNATIONAL</button><button class="gray">CANADA</button><button class="gray">ESPAÑOL</button><button class="gray">中文</button>
        </div>
    ...
    <div id="masthead">
        ...
        <!--          NYT logo-->
        <a href="https://www.nytimes.com" id="logo">
        ...
        <div id="stock">
            <p>S&P 500</p>
            <p style="color: #a9220f">-0.23%</p>
            <i class="fa fa-long-arrow-down" style="color: #a9220f"></i>
        </div>
    </div>
    <!--masthead end-->
