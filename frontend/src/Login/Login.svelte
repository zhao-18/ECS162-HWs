<div id="login">
    <!--        NYT Logo-->
    <a href="https://www.nytimes.com" id="login-logo">
        <!--          exerted from new york times homepage-->
    ...
    <!--    Terms and conditions-->
        <p id="term-condition">
            ...
            and
            <a href="https://help.nytimes.com/hc/en-us/articles/10940941449492-The-New-York-Times-Company-Privacy-Policy">Privacy Policy</a>.
        </p>

        <button class="alternate-login">Continue with Google</button>
        <button class="alternate-login">Continue with Facebook</button>
        <button class="alternate-login">Continue with Apple</button>
    </div>
</div>
